function export_SUMMI_london_capvol(vol_matrix_summit,snapshot_time);
...
filename = ['S:\Products\Research\market data\BMA Vol EoD\swaptionvol.market_import_bma_' ddate3  '_LONDON_capvol.dat'];
