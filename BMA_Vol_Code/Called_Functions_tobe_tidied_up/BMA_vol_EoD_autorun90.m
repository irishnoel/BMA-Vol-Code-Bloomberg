...
%while(stat==true) 
  ...
  EoD_date = t1(1:11);
%  EoD_date = datestr(today ,'dd-mmm-yyyy')
  ...
  destinationfile = ['\\hre.loc\DFS_SHARES\001080_GE_DEMU_DEPFA_HRE_Transfer\bmavol_test\BMAVol.BLANK.mkt'];
  ...
  destinationfile = ['\\hre.loc\DFS_SHARES\001080_GE_DEMU_DEPFA_HRE_Transfer\bmavol_test\BMAVol.LONDON.mkt'];
  copyfile(sourcefile, destinationfile);
