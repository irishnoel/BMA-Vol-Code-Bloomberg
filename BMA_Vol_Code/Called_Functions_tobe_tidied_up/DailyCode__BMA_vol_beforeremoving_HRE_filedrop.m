...
%while(stat==true) 
 ...
 % Busday = isbusday(EoD_date);
  ...
  sourcefile = ['\\depfa.loc\dfs_shares\001890_DP_USNY_RISK_IT_Market_Risk\AutoRun_BMA\BMA_Vol_EOD\Copies_of_EOD_Runs\swaptionvol.market_import_bma_' ddate3  '.dat'];
  ...
  sourcefile = ['\\depfa.loc\dfs_shares\001890_DP_USNY_RISK_IT_Market_Risk\AutoRun_BMA\BMA_Vol_EOD\Copies_of_EOD_Runs\swaptionvol.market_import_bma_' ddate3  '_LONDON.dat'];
