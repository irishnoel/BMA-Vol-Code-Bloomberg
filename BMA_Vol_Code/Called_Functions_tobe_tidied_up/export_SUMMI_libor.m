function export_SUMMI_libor(vol_matrix_summit,snapshot_time);
...
tenor = {'1Y','2Y','3Y','4Y','5Y','7Y','10Y','12Y','15Y','20Y','25Y','30Y'};
expiry =  {'1M','3M','6M','9M','1Y','2Y','3Y','4Y','5Y','6Y','7Y','8Y','9Y','10Y','15Y','20Y','25Y','30Y'};
%vol_matrix_summit(8,:) = [];

filename = ['S:\Products\Research\market data\BMA Vol Hourly\swaptionvol.market_import_libor_' ddate3  '.dat'];
...
%% export the vol
for i=1:1:12 %%        
    fprintf(fid,'IRFWDVOL	USD	LIBOR   SWOPT\t%s\r\n',tenor{i});
    fprintf(fid,'DATE\t%s\r\n',ddatenum);
    fprintf(fid,'ID\r\n');
    for j = 1:1:18
