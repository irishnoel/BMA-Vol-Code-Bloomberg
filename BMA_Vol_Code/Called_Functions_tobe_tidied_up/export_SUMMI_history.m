function export_SUMMI_history(vol_matrix_summit,snapshot_time);
...
%filename = ['C:\Andy\BMA EoD\swaptionvol.market_import_bma_' ddate3  '.dat'];
...
filename = ['\\depfa.loc\dfs_shares\001890_DP_USNY_RISK_IT_Market_Risk\AutoRun_Matlab_Queries\AutoRun_Matlab_BMA\BMA_Vol_EOD\Copies_of_EOD_Runs\swaptionvol.market_import_bma_' ddate3  '.dat'];
fid = fopen(filename,'w');
