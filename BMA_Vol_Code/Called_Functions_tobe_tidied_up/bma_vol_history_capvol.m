function [vol_matrix_summit,bma_vol_matrix,libor_vol_matrix,bma_rates,ratio_vol,r_bma_ratio1,r_bma_basis1,r_bma1,r_libor1,ddate,snapshot_time] = bma_vol_history_capvol(ddate,time_frame);
% Input Parameter 
% ddate : the date
...
export_SUMMI_london_capvol(vol_matrix_summit,snapshot_time);
...
filename = ['S:\Products\Research\market data\BMA vol raw data\swaptionvol.market_import_bma_' ddate3 '_EoD_capvol.mat'];
