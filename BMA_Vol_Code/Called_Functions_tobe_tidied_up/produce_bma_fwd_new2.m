function [fwd_bma,fwd_libor,fwd_ratio] = produce_bma_fwd_new2(ddate,r_bma_basis,r_libor);
...
matu35 = [ddmm num2str(yyyy+31)];
matu40 = [ddmm num2str(yyyy+32)];
Compounding = 4;
ValuationDate = ddate;
...
Rates(9) = Rates(9) + 0.3./10000;
Rates(10) = Rates(10) + 2./10000;
